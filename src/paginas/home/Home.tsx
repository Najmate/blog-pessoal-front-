            ...
            <Grid container direction="row" justifyContent="center" alignItems="center" style={{ backgroundColor: "#212121" }}>
                <Grid alignItems="center" item xs={6}>
                    <Box paddingX={20} >
                        ...
                        <Typography variant="h5" gutterBottom color="textPrimary" component="h5" align="center" style={{ color: "purple", fontWeight: "bold" }}>expresse aqui os seus pensamentos e opiniões!</Typography>
                    </Box>
                    <Box display="flex" justifyContent="center">
                        <Box marginRight={1}>
                        </Box>
                        <Button variant="outlined" style={{ borderColor: "purple", backgroundColor: "#212121", color: "purple" }}>Ver Postagens</Button>
                    </Box>
                </Grid>
                <Grid item xs={6} >
